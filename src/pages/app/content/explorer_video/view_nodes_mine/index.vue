...
q-page(
  ...
  div(:style=`{maxWidth: '800px',}`).row.full-width.items-start.content-start
    kalpa-loader(
      v-if="nodeEditing === null" :mangoQuery="queryNodesWorkspace" :sliceSize="1000" @items="nodesWorkspaceLoaded" v-slot=`{items, next}`)
    kalpa-loader(
      v-if="nodeEditing === null" :mangoQuery="queryNodesKalpa" :sliceSize="1000" @items="nodesKalpaLoaded" v-slot=`{items, next}`)
