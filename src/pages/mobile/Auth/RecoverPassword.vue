    ...
    q-page.text-center.bold
        ...
        .q-pa-md.q-gutter-y-sm
            form(ref="form")
                ...
                p.text-left.succes.text-caption.q-mt-sm(v-if="succesRestor") Новый пароль отправлен на указанный почтовый ящик!
        ...
        onSubmitRestore() {
            ...
            setTimeout(() => {
                if (this.$refs.emailReg.value === 'test@test.ru') {
                    this.succesRestor = false;
                    this.falseEmail = true;
                    this.submitting = false;
                } else {
                    this.submitting = false;
                    this.succesRestor = true;
