...
1. **Общие положения**
    1. Настоящее Пользовательское соглашение (далее – Соглашение) относится к сайту развлекательный видео портал «Kalpagrama» расположенному по адресу [kalpa.app](https://kalpa.app/), и ко всем соответствующим сайтам, связанным с сайтом [kalpa.app](https://kalpa.app/).
    2. Настоящее Соглашение регулирует отношения между Администрацией Cайта развлекательного видео портала «Kalpagrama» (далее – Администрация Cайта) и Пользователем данного Сайта.
...
2. **Определения терминов**
    1. Перечисленные ниже термины имеют для целей настоящего Соглашения следующее значение:
        ...
        2. Развлекательный видео портал [kalpa.app](https://kalpa.app/), содержащий информацию о Товарах, Продавце, позволяющий осуществить выбор, заказ и (или) приобретение Товара.
        3. Администрация сайта развлекательного видео портала [kalpa.app](https://kalpa.app/) – уполномоченные сотрудники на управления Сайтом, действующие от имени название организации.
        4. Пользователь сайта (далее Пользователь) – лицо, имеющее доступ к Сайту, посредством сети Интернет и использующее Сайт.
        5. Содержание Cайта развлекательного видео портала [kalpa.app](https://kalpa.app/) (далее – Содержание) - охраняемые результаты интеллектуальной деятельности, включая тексты литературных произведений, их названия, предисловия, аннотации, статьи, иллюстрации, обложки, музыкальные произведения с текстом или без текста, графические, текстовые, фотографические, производные, составные и иные произведения, пользовательские интерфейсы, визуальные интерфейсы, названия товарных знаков, логотипы, программы для ЭВМ, базы данных, а также дизайн, структура, выбор, координация, внешний вид, общий стиль и расположение данного Содержания, входящего в состав Сайта и другие объекты интеллектуальной собственности все вместе и/или по отдельности, содержащиеся на сайте Сайта.
...
4. **Права и обязанности сторон**
    ...
    2. **Пользователь вправе:**
        ...
        3. Задавать любые вопросы, относящиеся к услугам Сайта по электронной почте support@kalpa.app
