...
export default async ({ Vue, store: storeVue, router: VueRouter }) => {
  try {
    ...
    // node rate meta
    const rateMeta = [
      {name: EventApi.verbalizeRate(0.2), value: 0, valueMin: -1, valueMax: 0.2, color: 'rgba(255,26,5,1)', colorBackground: 'rgba(255,26,5,0.4)', order: 5},
      ...
      {name: EventApi.verbalizeRate(1), value: 1, valueMin: 0.8, valueMax: 2, color: 'rgba(113,49,164,1)', colorBackground: 'rgba(113,49,164,0.4)', order: 1}
    ]
