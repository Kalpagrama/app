...
.row.full-width
  ...
  //- user
  q-item(clickable v-ripple :to="`/app/user`" :style=`{height: '70px'}` @click="pageClick('/app/user')").row.full-width.items-center.content-center.q-px-sm
  ...
  data () {
    return {
      pages: [
        ...
        {name: 'Уведомления', icon: 'notifications', path: '/app/events'},
