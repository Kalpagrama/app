    ...
    div(:style=`{position: 'relative'}`).row.fit
      div(
        ...
        div(
          ...
          small(:style=`{borderRadius: '10px', background: 'rgba(0,0,0,0.0)'}`).q-pa-xs {{$time(stateLayerEditor.layerStart)}}
          .col
            .row.full-width.justify-center
              small(:style=`{borderRadius: '10px', background: 'rgba(0,0,0,0.0)'}`).q-pa-xs {{ $time(stateLayerEditor.layerEnd - stateLayerEditor.layerStart) }}
          small(:style=`{borderRadius: '10px', background: 'rgba(0,0,0,0.0)'}`).q-pa-xs {{$time(stateLayerEditor.layerEnd)}}
