    ...
    div(:style=`{position: 'relative'}`).row.fit
      div(
        ...
        div(
          ...
          small(:style=`{borderRadius: '10px', background: 'rgba(0,0,0,0.0)'}`).q-pa-xs {{$time(layerStart)}}
          .col
            .row.full-width.justify-center
              small(:style=`{borderRadius: '10px', background: 'rgba(0,0,0,0.0)'}`).q-pa-xs {{ $time(layerEnd - layerStart) }}
          small(:style=`{borderRadius: '10px', background: 'rgba(0,0,0,0.0)'}`).q-pa-xs {{$time(layerEnd)}}
