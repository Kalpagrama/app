...
const vueRoutesRegexp = /.+\/(auth|help|share|ui|about|links|\*|home|welcome|settings|user|user-render|node|block|block-render|graph|node-render|cube|joint|joint-render|sphere|sphere-threads|sphere-render|trends|category|content|cover|content-render|content_book|notifications|messages|workspace.*)(\/|\?|$).*/
