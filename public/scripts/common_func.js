...
const vueRoutesRegexp = /.+\/(auth|docs|share|about|links|\*|feeds|welcome|settings|user|node|joint|sphere|trends|content|content_book|notifications|messages|workspace.*)(\/|\?|$).*/
