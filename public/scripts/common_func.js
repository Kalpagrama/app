...
const vueRoutesRegexp = /.+\/(auth|docs|share|about|links|\*|feeds|welcome|settings|user|user-render|node|node-render|graph|joint|joint-render|sphere|sphere-threads|sphere-render|trends|content|content-render|content_book|notifications|messages|workspace.*)(\/|\?|$).*/
