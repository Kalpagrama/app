...
const vueRoutesRegexp = /.+\/(auth|help|share|ui|about|links|\*|feeds|welcome|settings|user|user-render|node|block|node-render|cube|joint|joint-render|sphere|sphere-threads|sphere-render|trends|content|cover|content-render|content_book|notifications|messages|workspace.*)(\/|\?|$).*/
